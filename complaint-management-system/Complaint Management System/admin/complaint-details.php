...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/complaint-management-system/complaint-management-system/Complaint Management System/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
